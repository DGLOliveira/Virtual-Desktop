...
export default function StartButtonContent({ isOpen }) {
    return(        
    <svg className={isOpen ? "startButtonClassic startButtonClassicActive" : "startButtonClassic"} width="400" height="400" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            className="hex hex1"
            style={{
              mixBlendMode: "screen",
