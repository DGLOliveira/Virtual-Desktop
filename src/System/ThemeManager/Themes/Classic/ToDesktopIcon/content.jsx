...
export default function Icon({ isActive }) {
    return (
        <svg className={isActive ? "toDesktopIconClassic toDesktopIconClassicActive" : "toDesktopIconClassic"} width="400" height="400" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                className={isActive ? "hex hex3 animate-to-desktop-large-hexagon" : "hex hex3"}
